...
module.exports = ({ extensionURL = '', username = 'Unknown', clientID = '', clientSecret = '' }) => {
  ...
  /**
   * This rule has been automatically generated by
   * Unknown - Auth0 -  at 2019-10-16T05:39:16.011Z
   */
  var request = require('request@2.56.0');
  var queryString = require('querystring');
  var Promise = require('native-or-bluebird@1.2.0');
  ...
  var config = {
    ...
    token: {
      clientId: 'BvS5iRrCfC6FmXRLN026TlnCI09eJy9V',
      clientSecret: '9mnk3dnuQgJYDXg74qTK7lrroDWv6Ox_GoChx6S8kSCt_QZeIK4eSlM_5SD2UQp9',
      issuer: auth0.domain
    }
  };
